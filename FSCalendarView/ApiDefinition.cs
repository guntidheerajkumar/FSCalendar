...
namespace FSCalendarView
{
	...
	interface FSCalendarCell
	{
		...
		FSCalendarAppearance CalenarCellAppearance { get; set; }
		...
		// @property (readonly, getter = isPlaceholder, nonatomic) BOOL placeholder;
		[Export("placeholder")]
	...
	interface FSCalendarHeaderView
	{
		...
		// @property (nonatomic, weak) FSCalendarAppearance * appearance;
		[Export("appearance", ArgumentSemantic.Weak)]
		FSCalendarAppearance CalenarHeaderViewAppearance { get; set; }
	...
	interface FSCalendarDataSource
	{
		...
		[return: NullAllowed]
		string TitleForDate(FSCalendar calendar, NSDate date);
	...
	{
		// @optional -(BOOL)calendar:(FSCalendar * _Nonnull)calendar shouldSelectDate:(NSDate * _Nonnull)date;
		[Export("calendar:shouldSelectDate:")]
		bool Calendar(FSCalendar calendar, NSDate date);

		// @optional -(void)calendar:(FSCalendar * _Nonnull)calendar didSelectDate:(NSDate * _Nonnull)date;
		[Export("calendar:didSelectDate:")]
		void DidSelectDate(FSCalendar calendar, NSDate date);

		// @optional -(BOOL)calendar:(FSCalendar * _Nonnull)calendar shouldDeselectDate:(NSDate * _Nonnull)date;
		[Export("calendar:shouldDeselectDate:")]
		bool ShouldDeselectDate(FSCalendar calendar, NSDate date);

		// @optional -(void)calendar:(FSCalendar * _Nonnull)calendar didDeselectDate:(NSDate * _Nonnull)date;
		...
		// @optional -(void)calendar:(FSCalendar * _Nonnull)calendar willDisplayCell:(FSCalendarCell * _Nonnull)cell forDate:(NSDate * _Nonnull)date atMonthPosition:(FSCalendarMonthPosition)position;
		[Export("calendar:willDisplayCell:forDate:atMonthPosition:")]
		void Calendar(FSCalendar calendar, FSCalendarCell cell, NSDate date, FSCalendarMonthPosition position);
	...
	interface FSCalendar
	{
		...
		// @property (assign, nonatomic) BOOL focusOnSingleSelectedDate;
		[Export("focusOnSingleSelectedDate")]
		bool FocusOnSingleSelectedDate { get; set; }
		...
		// -(void)selectDate:(NSDate * _Nonnull)date scrollToDate:(BOOL)scrollToDate;
		[Export("selectDate:scrollToDate:")]
		void SelectDate(NSDate date, bool scrollToDate);
	...
	interface FSCalendarDelegateProxy
	{
		...
		[Export("shouldDeselectDate:")]
		bool ShouldDeselectDate(NSDate date);

		// -(void)didDeselectDate:(NSDate *)date;
		[Export("didDeselectDate:")]
		void DidDeselectDate(NSDate date);
	...
	interface FSCalendarStickyHeader
	{
		...
		// @property (nonatomic, weak) FSCalendarAppearance * appearance;
		[Export("appearance", ArgumentSemantic.Weak)]
		FSCalendarAppearance StickyHeaderAppearance { get; set; }
	...
	interface FSCalendar_Dynamic
	{
		...
		// @property (readonly, nonatomic) CGFloat preferredPadding;[Static]
		[Static]
		...
		[Export("invalidateAppearanceForCell:")]
		void InvalidateAppearanceForCell(FSCalendarCell cell);
